...
picker.api.DocsViewMode = {GRID: "grid", LIST: "list"};
goog.array = {};
...
var PICKER_THIRD_PARTY_API = !1, PICKER_THIRD_PARTY_LEGACY_API = !1;
picker.api.ContainerRenameType = {PICASA_NAME: "pname", PICASA_NEW_NAME: "pnew"};
picker.api.PhotosMode = {BLOGGER: "blogger", EDIT: "edit", PALETTE: "palette", ROLLUP_ALBUM: "rollupAlbum"};
picker.api.ViewId = {
    DOCS: "all",
...
picker.api.View.prototype.toArray = function() {
    var a = goog.object.filter(this.opts, function(a) {
        return null !== a
    }), a = goog.object.isEmpty(a) ? null : a, a = [this.id_, this.label_, a], b = goog.array.findIndexRight(a, goog.functions.identity);
...
goog.Uri.QueryData.prototype.getValues = function(a) {
    this.ensureKeyMapInitialized_();
    var b = [];
    if (goog.isString(a)) this.containsKey(a) && (b = goog.array.concat(b, this.keyMap_.get(this.getKeyName_(a)))); else {
...
goog.dom.setTextContent = function(a, b) {
    ...
    if ("textContent" in a) a.textContent = b; else if (a.nodeType == goog.dom.NodeType.TEXT) a.data = b; else if (a.firstChild && a.firstChild.nodeType == goog.dom.NodeType.TEXT) {
...
goog.dom.getNodeAtOffset = function(a, b, c) {
    ...
    for (var d = 0, e = null; 0 < a.length && d < b;) if (e = a.pop(), !(e.nodeName in goog.dom.TAGS_TO_IGNORE_)) if (e.nodeType == goog.dom.NodeType.TEXT) var f = e.nodeValue.replace(/(\r\n|\r|\n)/g, "").replace(/ +/g, " "),
        d = d + f.length; else if (e.nodeName in goog.dom.PREDEFINED_TAG_VALUES_) d += goog.dom.PREDEFINED_TAG_VALUES_[e.nodeName].length; else for (f = e.childNodes.length - 1; 0 <= f; f--) a.push(e.childNodes[f]);
...
picker.api.ActionPaneType = {SCHEMER: "sc", SPICYBOWL: "sp"};
picker.api.ChromeMode = {FULL: "full", INLINE: "inline", NONE: "none"};
picker.api.CropMode = {
    DEFAULT: "default",
    FIXED: "f",
...
picker.api.Protocol = {IFPC: "ifpc", IFRAMES: "iframes", INJECTED: "injected", GADGETS: "gadgets"};
picker.api.Protocol.INJECTED_FUNCTION_NAME = "_pickerCallback";
picker.api.ThumbnailSize = {DEFAULT: "default", ORIGINAL: "orig"};
picker.api.TitleBarIconId = {PHOTOS: 1};
picker.api.UploadButton = function(a) {
    this.uploadConfigurationId_ = a
};
picker.api.UploadButton.Properties = {UPLOAD_CONFIG_ID: "ucid"};
...
picker.api.SafeSearch = {OFF: "off", STRICT: "active", MODERATE: "moderate"};
...
picker.api.ImageSearchView.Type = {GETTY: "getty", GOOGLE_IMAGE_SEARCH: "gis", TIME_LIFE: "life"};
picker.api.ImageSearchView.License = {NONE: "*", REUSE: "r", COMMERCIAL_REUSE: "cr", REUSE_WITH_MODIFICATION: "rwm", COMMERCIAL_REUSE_WITH_MODIFICATION: "crwm"};
...
picker.api.ImageSearchView.Colorization = {BLACK_AND_WHITE: "mono", GRAYSCALE: "gray", COLOR: "color"};
...
picker.api.ImageSearchView.ImageType = {ALL: "", FACES: "face", CLIPART: "clipart", LINEART: "lineart", PHOTO: "photo"};
...
picker.api.MapsMode = {ALL: "all", POINT: "point"};
...
picker.api.PhotosView.UploadPosition = {FIRST: "first", LAST: "last"};
picker.api.PhotosView.VisibilityFilter = {ALL: 0, PUBLIC: 1, PUBLIC_OR_UNLISTED: 2, PUBLIC_OR_DOMAIN_PUBLIC: 3};
...
picker.api.UrlViewType = {ALL: "all", IMAGE: "image", VIDEO: "video"};
...
picker.api.ViewGroup.Option = {COLLAPSIBLE: "collapsible"};
picker.api.ViewGroup.CollapsibleType = {COLLAPSED: "collapsed", EXPANDED: "expanded"};
...
picker.api.ViewGroup.prototype.toString = function() {
    if (this.root_) {
        var a = ["{root:", this.root_.toString(), ",items:", this.getItemsString()], b = this.getOptionsString();
...
goog.style.getPageOffset = function(a) {
    ...
    var e = !goog.style.GET_BOUNDING_CLIENT_RECT_ALWAYS_EXISTS && goog.userAgent.GECKO && c.getBoxObjectFor && !a.getBoundingClientRect && "absolute" == d && (b = c.getBoxObjectFor(a)) && (0 > b.screenX || 0 > b.screenY),
        f = new goog.math.Coordinate(0, 0), g = goog.style.getClientViewportElement(c);
    if (a == g) return f;
...
goog.events.ListenerMap.prototype.hasListener = function(a, b) {
    ...
    return goog.object.some(this.listeners, function(a, g) {
        for (var h = 0; h < a.length; ++h) if (!(c && a[h].type != d || e && a[h].capture != b)) return !0;
        return !1
    })
};
...
goog.events.EventHandler.prototype.unlisten = function(a, b, c, d, e) {
    if (goog.isArray(b)) for (var f = 0; f < b.length; f++) this.unlisten(a, b[f], c, d, e); else if (a = goog.events.getListener(a, b, c || this.handleEvent, d, e || this.handler_ || this)) goog.events.unlistenByKey(a), delete this.keys_[a.key];
    return this
};
...
picker.api.CalloutArrow.prototype.createDom = function() {
    var a = this.getDomHelper(), b = a.createDom("div");
    this.setElementInternal(b);
    var c = a.createDom("div", "picker-min-arrow-inner"), d = a.createDom("div", "picker-min-arrow-border");
    a.appendChild(b, c);
    a.appendChild(b, d)
};
...
picker.api.GadgetsLoader.loadFromUrl = function(a, b) {
    if (!picker.api.GadgetsLoader.hasGadgetsLoaded(b)) {
        var c = b || goog.dom.getDomHelper(document), d = c.createElement("script");
        d.src = a;
...
picker.api.GadgetsLoader.execOnLoad = function(a, b) {
    ...
    if (picker.api.GadgetsLoader.hasGadgetsLoaded(b)) a(); else if (picker.api.GadgetsLoader.execOnLoadCallbacks_) picker.api.GadgetsLoader.execOnLoadCallbacks_.push(a); else var d = picker.api.GadgetsLoader.execOnLoadCallbacks_ = [a],
...
goog.positioning.ClientPosition.prototype.reposition = function(a, b, c, d) {
    goog.asserts.assert(a);
    var e = goog.style.getViewportPageOffset(goog.dom.getOwnerDocument(a)), f = this.coordinate.x + e.x, e = this.coordinate.y + e.y, g = goog.positioning.getOffsetParentPageOffset(a),
        f = f - g.x, e = e - g.y;
...
goog.positioning.ViewportClientPosition.prototype.reposition = function(a, b, c, d) {
    var e = goog.style.getClientViewportElement(a), e = goog.style.getVisibleRectForElement(e), f = goog.dom.getDomHelper(a).getDocumentScrollElement(),
        f = new goog.math.Coordinate(this.coordinate.x + f.scrollLeft, this.coordinate.y + f.scrollTop), g = goog.positioning.Overflow.FAIL_X | goog.positioning.Overflow.FAIL_Y, h = b,
...
picker.api.MinimalPicker = function(a, b, c, d, e, f) {
    var g = c || goog.dom.getDomHelper(), h = g.createDom("div", "picker-min goog-menu"), k = new goog.Uri(a), l = "true" == k.getParameterValue(picker.api.Feature.MINIMAL_MODE_NEW);
...
picker.api.MinimalPicker.prototype.reposition = function() {
    if (this.iframe_) {
        ...
        var a = this.getPosition(), b = this.getPinnedCorner();
...
picker.api.MinimalPicker.prototype.setDefaultRelayUrl_ = function(a) {
    var b = null, c = a.indexOf("/picker?");
    -1 < c ? b = a.substring(0, c + 8 - 1) : goog.string.endsWith(a, "/picker") && (b = a);
...
picker.api.MinimalPicker.prototype.closePicker_ = function() {
    var a = {action: picker.api.Action.CANCEL};
    this.setVisible(!1);
    this.callback_(a)
};
goog.dom.tags = {};
...
goog.html.SafeHtml.create = function(a, b, c) {
    ...
    if (b) for (var f in b) {
        ...
        var g = b[f];
        if (null != g) {
            if (g instanceof goog.string.Const) g = goog.string.Const.unwrap(g); else if ("style" == f.toLowerCase()) g =
                goog.html.SafeHtml.getStyleValue_(g); else {
                if (/^on/i.test(f)) throw Error('Attribute "' + f + '" requires goog.string.Const value, "' + g + '" given.');
                if (g instanceof goog.html.SafeUrl) g = goog.html.SafeUrl.unwrap(g); else if (f.toLowerCase() in goog.html.SafeHtml.URL_ATTRIBUTES_) throw Error('Attribute "' + f + '" requires goog.string.Const or goog.html.SafeUrl value, "' + g + '" given.');
            }
...
goog.ui.ModalPopup.prototype.resizeBackground_ = function() {
    ...
    var a = this.getDomHelper().getDocument(), b = goog.dom.getWindow(a) || window, c = goog.dom.getViewportSize(b),
        b = Math.max(c.width, Math.max(a.body.scrollWidth, a.documentElement.scrollWidth)), a = Math.max(c.height, Math.max(a.body.scrollHeight, a.documentElement.scrollHeight));
...
goog.ui.Dialog.prototype.decorateInternal = function(a) {
    ...
    var b = this.class_ + "-title", c =
        this.class_ + "-title-text", d = this.class_ + "-title-close";
    ...
    this.titleTextEl_ ? (this.title_ = goog.dom.getTextContent(this.titleTextEl_), this.titleTextEl_.id || (this.titleTextEl_.id =
        this.getId())) : (this.titleTextEl_ = goog.dom.createDom("span", {className: c, id: this.getId()}), this.titleEl_.appendChild(this.titleTextEl_));
    this.titleTextId_ = this.titleTextEl_.id;
    goog.a11y.aria.setState(a, goog.a11y.aria.State.LABELLEDBY, this.titleTextId_ || "");
...
goog.ui.Dialog.prototype.onKey_ = function(a) {
    ...
    if (a.type == goog.events.EventType.KEYDOWN) if (this.escapeToCancel_ && a.keyCode == goog.events.KeyCodes.ESC) {
        ...
        if ("BUTTON" ==
            e.tagName && !e.disabled) f = e.name; else if (e == this.titleCloseEl_) this.handleTitleClose_(); else if (d) {
...
goog.ui.Dialog.ButtonSet.DefaultButtons = {
    OK: {key: goog.ui.Dialog.DefaultButtonKeys.OK, caption: goog.ui.Dialog.DefaultButtonCaptions.OK},
    CANCEL: {key: goog.ui.Dialog.DefaultButtonKeys.CANCEL, caption: goog.ui.Dialog.DefaultButtonCaptions.CANCEL},
    YES: {key: goog.ui.Dialog.DefaultButtonKeys.YES, caption: goog.ui.Dialog.DefaultButtonCaptions.YES},
    NO: {key: goog.ui.Dialog.DefaultButtonKeys.NO, caption: goog.ui.Dialog.DefaultButtonCaptions.NO},
    SAVE: {key: goog.ui.Dialog.DefaultButtonKeys.SAVE, caption: goog.ui.Dialog.DefaultButtonCaptions.SAVE},
...
goog.events.MouseWheelHandler.prototype.handleEvent = function(a) {
    ...
    if ("mousewheel" == a.type) {
        ...
        -3), goog.isDef(a.axis) && a.axis === a.HORIZONTAL_AXIS ? b = d : c = d;
...
picker.api.Picker.prototype.handleKeydown_ = function(a) {
    a.keyCode == goog.events.KeyCodes.ESC && (a = {action: picker.api.Action.CANCEL}, this.setVisible(!1), this.callback_(a))
};
...
picker.api.Picker.prototype.reposition = function() {
    if (this.hasFeature_(picker.api.Feature.SHADE_DIALOG)) {
        var a = goog.style.getSize(this.getElement()), b = goog.dom.getViewportSize(this.getDomHelper().getWindow()), a = Math.max(Math.floor(b.width / 2 - a.width / 2), 0),
...
picker.api.Picker.prototype.setVisible = function(a) {
    if (a != this.isVisible() && this.autoSizeDialog_) {
        var b = this.getDomHelper().getDocument(), b = goog.dom.getWindow(b) || window;
...
picker.api.properties.Response = {ACTION: "action", EXTRA_USER_INPUTS: "extraUserInputs", DOCUMENTS: "docs", PARENTS: "parents", VIEW: "view", VIEW_TOKEN: "viewToken"};
picker.api.properties.ExtraUserInputKey = {IS_ATTACHMENT: "isAttachment"};
...
picker.api.properties.Thumbnail = {HEIGHT: "height", URL: "url", WIDTH: "width"};
picker.api.properties.Map = {ADDRESS_LINES: "addressLines", PHONE_NUMBERS: "phoneNumbers", PHONE_NUMBER: "number", REFERENCE: "reference"};
picker.api.properties.Video = {ASPECT_RATIO: "aspectRatio", CONTENT_ID: "video_cid", DURATION: "duration"};
picker.api.properties.Person = {DISPLAY_NAME: "name", EMAIL: "email", USER_ID: "userId"};
picker.api.properties.IframesChannel = {GET_HEALTHC_METHOD: "getHealthc", GET_VARC_METHOD: "getVarc", SEND_COMMAND_METHOD: "sendCommand"};
picker.api.properties.ViewToken = {VIEW_ID: 0, LABEL: 1, VIEW_OPTIONS: 2};
var gdocs = {domUtil: {}};
...
gdocs.UrlUtil.executeUrl = function(a) {
    chrome.windows.create({url: gdocs.UrlUtil.createUrl_(a), type: "normal"})
};
...
gdocs.UrlUtil.createExternalFeedbackUrl_ = function() {
    var a = "https://chrome.google.com/webstore/support/" + chrome.i18n.getMessage("@@extension_id"), b = chrome.i18n.getMessage("@@ui_locale");
    b && (a += "?hl=" + b);
    return a + "#bug"
};
gdocs.UrlUtil.createExternalHelpUrl_ = function() {
    var a = "http://support.google.com/drive/?", b = chrome.i18n.getMessage("@@ui_locale");
    b && (a += "hl=" + b + "&");
...
gdocs.OptionsPage.prototype.displayPicker_ = function() {
    chrome.identity.getAuthToken({interactive: !0}, goog.bind(this.displayOauthPicker_, this))
};
