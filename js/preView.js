            ...
            buttons: [{
                ...
                customize: function(xlsx, a, b, v) {
                    ...
                    for (var mergeCell in mergeCellData) {
                        setMergeCells(sheet, mergeCellData, mergeCell, ['order_index',
                            'order_num',
                            'order_time',
                            'wangwang',
                            'express',
                    ...
                    $('sheetData', sheet).append(`<row r="${totalIndex}">
                        ...
                        <c r="J${totalIndex}" s="22"><v>-</v></c>
                        <c r="K${totalIndex}" s="22"><v>${totalData.totalPrice}</v></c>
                        <c t="inlineStr" r="L${totalIndex}"><is><t>${totalData.totalPay}</t></is></c>
                        <c t="n" r="M${totalIndex}"><v>-</v></c>
                        <c r="N${totalIndex}" s="22"><v>${totalData.totalPurchasePrice}</v></c>
                        <c t="n" r="O${totalIndex}"><v>${totalData.totalPurchaseExpress}</v></c>
                        <c r="P{totalIndex}" s="22"><v>${totalData.totalPurchaseBox}</v></c>
                        <c r="Q{totalIndex}" s="22"><v>${totalData.totalProfit}</v></c>
                    </row>`);
                    totalIndex++;
//                     $('sheetData', sheet).append(`<row r="${totalIndex}">
//                         <c r="A${totalIndex}" s="65"><h><img src="https://img.alicdn.com/bao/uploaded/i4/125332605/TB2PvOScvjM8KJjSZFsXXXdZpXa_!!125332605.jpg_sum.jpg" width="50"></h></c>
//                         <c r="B${totalIndex}" s="65"><v>-</v></c>
//                         <c t="inlineStr" r="C${totalIndex}"><is><t>-</t></is></c>
//                         <c t="inlineStr" r="D${totalIndex}"><is><t></t></is></c>
//                         <c t="inlineStr" r="E${totalIndex}"><is><t>-</t></is></c>
